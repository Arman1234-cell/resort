      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        <div>
          ...
          <div className="space-y-4 text-[var(--color-brand-muted)]">
            <p>
              <strong className="text-white font-sans uppercase text-sm tracking-wider block mb-1">Address</strong>
              123 Paradise Cove, Halc Island, HC 12345
            </p>
            <p>
              <strong className="text-white font-sans uppercase text-sm tracking-wider block mb-1">Phone</strong>
              +1 (800) 123-4567
            </p>
            <p>
              <strong className="text-white font-sans uppercase text-sm tracking-wider block mb-1">Email</strong>
              contact@halcresort.com
            </p>
          </div>
        </div>
        ...
        <div>
          <form className="space-y-6">
            <div>
              ...
              <input
                type="text"
                className="w-full bg-transparent border-b border-white/20 pb-2 focus:outline-none focus:border-[var(--color-brand-accent)] transition-colors"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                rows={4}
                className="w-full bg-transparent border-b border-white/20 pb-2 focus:outline-none focus:border-[var(--color-brand-accent)] transition-colors resize-none"
              ></textarea>
            </div>
